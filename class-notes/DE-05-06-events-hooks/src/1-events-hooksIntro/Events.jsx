...
const butonBaslik=(a)=>{
  ...
  return (
    ...
    <div className="container text-center mt-4">
      ...
      <button className="btn btn-info" onClick={()=>butonBaslik(new Date().getFullYear())} >TEMİZLE</button>

      <button className="btn btn-danger" onClick={()=>alert("buton tıklandı")}> TIKLANDI</button>
    </div>
  );
}
//?-------------------------------------------------------------------

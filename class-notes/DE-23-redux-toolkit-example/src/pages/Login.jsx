...
// {email, password} şeklinde yazmamın nedeni, 2 tane useState yolluyorum, aslında {email:email,password:password} şeklinde object gönderiyorum, ama burada da slice sayfasında da aynı email kelimesini kullandığım için, üstteki gibi yazım yeterli
    navigate("/")
  };
